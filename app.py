...
# ---------------------------------------------------------------------------
# Serve Sermon Pro frontend (Vite build output).
# Mounted last so it acts as catch-all for SPA routes — keep any new API
# routes above this block.
# ---------------------------------------------------------------------------
_FRONTEND_DIST = os.path.join(os.path.dirname(__file__), "dashboard", "dist")
