...
const SECRET_KEY = import.meta.env.VITE_ENCRYPTION_KEY || "Sermon Pro-Static-Salt-Change-Me";
  ...
  const Sidebar = () => (
    <div className="w-20 lg:w-64 bg-surface border-r border-white/5 flex flex-col h-full shrink-0 transition-all duration-300">
      <div className="p-6 flex items-center gap-3">
        ...
        <span className="font-bold text-lg text-white hidden lg:block tracking-tight">Sermon Pro</span>
      </div>
